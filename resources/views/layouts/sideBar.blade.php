    ...
    <aside class = "w-60 -translate-x-48 fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-black  ">
        ...
        <div class= "max hidden text-white mt-20 flex-col space-y-2 w-full h-[calc(100vh)]">
            <a href="{{route('admin')}}" class =  "hover:bg-white w-full text-white hover:text-black dark:hover:text-blue-500  p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">
                <i class="fas fa-columns w-4 h-4"></i>
                <div>
                    Dashboard
                </div>
            </a>
            <a href="{{route('speciality')}}" class =  "hover:bg-white w-full text-white hover:text-black dark:hover:text-blue-500 bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">               
                <i class="fas fa-stethoscope w-4 h-4"></i>                     
                <div>
                    Specialty
                </div>
            </a>
            <a href="{{route('medication')}}" class =  "hover:bg-white w-full text-white hover:text-black dark:hover:text-blue-500 bg-[#1E293B] p-2 pl-8 rounded-full transform ease-in-out duration-300 flex flex-row items-center space-x-3">               
        ...
        <div class= "mini mt-20 flex flex-col space-y-2 w-full h-[calc(100vh)]">
            <a href="{{route('admin')}}" class= "hover:bg-black justify-end pr-5 text-white hover:text-blue-500 dark:hover:text-black w-full  p-3 rounded-full transform ease-in-out duration-300 flex">
                <i class="fas fa-columns w-4 h-4"></i>                  
            </a>
            <a href="{{route('speciality')}}" class= "hover:bg-black justify-end pr-5 text-white hover:text-blue-500 dark:hover:text-black w-full   p-3 rounded-full transform ease-in-out duration-300 flex">
                    <i class="fas fa-stethoscope w-4 h-4"></i>                 
            </a>
            <a href="{{route('medication')}}" class= "hover:bg-black hover:ml-4 justify-end pr-5 text-white hover:text-blue-500 dark:hover:text-black w-full  p-3 rounded-full transform ease-in-out duration-300 flex">
             <i class="fas fa-pills w-4 h-4"></i>            
            </a>
        </div>
